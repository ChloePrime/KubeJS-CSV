export class CsvIO {
     ...
     */
    public static parse(document: string): Array<any>
     ...
     */
    public static read(path: string|java.nio.file.Path): Array<any>
     ...
     */
    public static toString(content: Array<any>): string
     ...
     * @param content the array of JavaScript objects.
     */
    public static write(path: string|java.nio.file.Path, content: Array<any>): void
     ...
     * @param path path to the CSV file.
     */
    public static delete(path: string|java.nio.file.Path): void
}
